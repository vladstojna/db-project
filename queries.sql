...
-- #3
SELECT DISTINCT rescue_process_number FROM emergency_event NATURAL INNER JOIN (
	SELECT * FROM triggers
	EXCEPT
	SELECT medium_number, entity_name, rescue_process_number FROM audits) AS foo
