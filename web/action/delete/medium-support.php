...
if (isset($medium_number) && isset($entity_name)) {
	try {
		$sql = 'DELETE FROM medium_support WHERE medium_number = :number AND entity_name = :name;';
...
$data = array(
	'result'  => query('SELECT * FROM medium_support NATURAL INNER JOIN medium;'),
	'caption' => 'Support Mediums',
