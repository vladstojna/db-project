...
if (isset($medium_number) && isset($entity_name)) {
	try {
		$sql = 'DELETE FROM medium_rescue WHERE medium_number = :number AND entity_name = :name;';
...
$data = array(
	'result'  => query('SELECT * FROM medium_rescue NATURAL INNER JOIN medium;'),
	'caption' => 'Rescue Mediums',
